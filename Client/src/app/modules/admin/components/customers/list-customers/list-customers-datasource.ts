...
export class ListCustomersDataSource extends DataSource<ListCustomersItem> {
   ...
   */
  connect(): Observable<ListCustomersItem[]> {
   ...
   */
  private getPagedData(data: ListCustomersItem[]): ListCustomersItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ListCustomersItem[]): ListCustomersItem[] {
